...
public class MinistereStructureController {
    ...
    private final MinistereStructureService ministere_SService;

    public MinistereStructureController(MinistereStructureService ministere_sService) {
        ministere_SService = ministere_sService;
    }

    @PostMapping(path = "/ministereStructs")
    public ResponseEntity<MinistereStructure> create(@Valid @RequestBody MinistereStructureDTO ministereSDTO) throws URISyntaxException {
        ...
        MinistereStructure minS =  ministere_SService.create(ministereSDTO);
