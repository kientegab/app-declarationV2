...
public class TokenProvider {
    ...
    public AuthenticationInformationDto createCustomAuthToken(Authentication authentication, boolean rememberMe) {
        String authorities = authentication.getAuthorities().stream()
            .map(GrantedAuthority::getAuthority)
            .collect(Collectors.joining(","));
        ...
        String refreshToken = Jwts.builder()
            ...
            new AuthenticationInformationDto(accessToken, validity.getTime()/1000, refreshToken, jti, getAdditionalTokenInformation(authentication));
