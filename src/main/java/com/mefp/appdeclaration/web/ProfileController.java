...
public class ProfileController {
    ...
    public ResponseEntity<List<Profile>> getAllProfiles() {
        List<Profile> profils = profileService.getList();
    ...
    @GetMapping("/profiles/mat/{matricule}")
    public ResponseEntity<List<Profile>> getProfileMatricule(@PathVariable String matricule) {
        log.debug("REST request to get Profile : {}", matricule);
        List<Profile> profile = profileService.getProfilByMatricule(matricule);
