...
import com.mefp.appdeclaration.entities.Agent;
import com.mefp.appdeclaration.repositories.AgentRepository;
...
import com.mefp.appdeclaration.web.vm.AffectationVM;
import com.mefp.appdeclaration.web.vm.ManagedAgentVM;
import com.mefp.appdeclaration.web.vm.ProfilerVM;
...
public class AgentController {
    ...
    @GetMapping("/agents")
    public ResponseEntity<List<AgentStructure>> getAllAgents() {
        List<AgentStructure> agents = agentService.getList();
