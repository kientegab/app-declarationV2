...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mefp.appdeclaration.repositories.AgentRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mefp.appdeclaration.repositories.AgentRepository.USERS_BY_EMAIL_CACHE);
